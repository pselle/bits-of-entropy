...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EmojiComponent = __webpack_require__(/*! ./EmojiComponent.jsx */ 168);
	
	var _EmojiComponent2 = _interopRequireDefault(_EmojiComponent);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.storeFieldRef = _this.storeFieldRef.bind(_this);
	    _this.state = {
	      emojis: [{
	        emoji: "😀",
	        probability: 0.1
	  ...
	  _createClass(App, [{
	    ...
	    value: function updateProbability(newValue, index) {
	    ...
	    key: 'removeEmoji',
	    value: function removeEmoji(index) {
	      var newState = this.state;
	    ...
	    key: 'storeFieldRef',
	    value: function storeFieldRef(ref) {
	      this.setState({ ref: ref });
	    }
	  }, {
	    key: 'shannonEntropy',
	    value: function shannonEntropy(probabilities) {
	      // where acc is the accumulator
	      return -1 * Array.from(probabilities).reduce(function (acc, p) {
	    ...
	    value: function render() {
	      ...
	      var probabilities = this.state.emojis.map(function (_ref) {
	        var probability = _ref.probability;
	        return probability;
	      }).filter(function (p) {
	        return p > 0;
	      });
	      var calc = this.shannonEntropy(probabilities).toFixed(1);
	      var sum = probabilities.reduce(function (acc, p) {
	        return +acc + +p;
	      }).toFixed(1);
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            'Current sum of probabilities (should equal 1): ',
	            sum
	          ),
	          this.state.emojis.map(function (emoji, index) {
	            return _react2.default.createElement(
	              'div',
	              { className: 'emoji-wrapper', key: index },
	              _react2.default.createElement(_EmojiComponent2.default, { emoji: emoji.emoji, probability: emoji.probability, key: index + 1 * 10, onChange: function onChange(event) {
	                  return _this2.updateProbability(event.target.value, index);
	                } }),
	              _react2.default.createElement(
	                'button',
	                { onClick: function onClick(event) {
	                    return _this2.removeEmoji(index);
	                  }, key: index + 1 * .1 },
	                'Remove'
	              )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmojiComponent = function (_React$Component) {
	  _inherits(EmojiComponent, _React$Component);
	
	  function EmojiComponent(props) {
	    _classCallCheck(this, EmojiComponent);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(EmojiComponent).call(this, props));
	  }
	  ...
	  _createClass(EmojiComponent, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement("input", { type: "number", step: "0.1", defaultValue: this.props.probability, name: this.props.index, onChange: this.props.onChange })
	      );
	    }
	  }]);
